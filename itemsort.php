...
$connection=mysqli_connect("localhost","root","root","lankastall");
		 ...
		 if($sortby='lohi') 																									//error
		 {
		 
   $query1 = mysqli_query($connection,"SELECT * FROM itemdetails where code='$c' ORDER BY price ASC;");
echo "<section id='itemtable'>";
   ...
   $query1 = mysqli_query($connection,"SELECT * FROM itemdetails where code='$c' ORDER BY price DESC;");
echo "<section id='itemtable'>";
