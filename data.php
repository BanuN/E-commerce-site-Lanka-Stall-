...
$iname=mysqli_real_escape_string($connection,$_POST['iname']);
...
mysqli_query($connection,"INSERT INTO itemdetails(sno,itemname,category,code,material,weight,size,price,stock,image,pname,email,location) 
VALUES('$sno','$iname','$category','$code','$material','$weight','$size','$price','$stock','$image','$pname','$email','$location')");
